...
#define OLED_SCL     GPIO_Pin_4      //D0
#define OLED_SDA     GPIO_Pin_5      //D1
#define OLED_RST     GPIO_Pin_6      //RST
...
void OLED_P8x16Num_8bit2(unsigned char x,unsigned char y,unsigned char Number);
void OLED_P8x16Num_8bit3(unsigned char x,unsigned char y,unsigned char Number);
