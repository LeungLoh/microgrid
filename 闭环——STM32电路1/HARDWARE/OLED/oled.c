...
{0x04,0x04,0x7E,0x01,0x80,0x40,0x3E,0x00,0x00,0xFE,0x00,0x00,0x7E,0x80,0xE0,0x00},/*"流",3*/
...
{0x80,0x40,0x20,0x1E,0x20,0x40,0x40,0x7F,0x44,0x44,0x44,0x44,0x44,0x40,0x40,0x00},/*"定",5*/

{0x10,0x60,0x02,0x8C,0x00,0xFE,0x02,0xF2,0x02,0xFE,0x00,0xF8,0x00,0xFF,0x00,0x00},
{0x04,0x04,0x7E,0x01,0x80,0x47,0x30,0x0F,0x10,0x27,0x00,0x47,0x80,0x7F,0x00,0x00},/*"测",6*/
...
///////////////////////////////////////////////////////////////////////////////
/*****************设置汉字循环显示位置（只能是某一行）*************************/
void OLED_H_Scroll(unsigned char x, unsigned char y) 
{ 
...
void Dis_Float(unsigned char Y,unsigned char X,double real,unsigned char N) 
{
		...
		*/
		...
		n[0]=(real_int/1)%10; 
		n[1]='.';
		n[2]=(real_decimal/100)%10;
		n[3]=(real_decimal/10)%10;
		n[4]=real_decimal%10;
		n[2+N]='\0';
